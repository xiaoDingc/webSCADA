...
(function(g) {
    ...
    q(A.prototype, {
        ...
        getSVG: function(b) {
            ...
            e.destroy();
            p(c);
            if (s && (c = f.match(/<\/svg>(.*?$)/))) c = '<foreignObject x="0" y="0 width="200" height="200"><body xmlns="http://www.w3.org/1999/xhtml">' + c[1] + "</body></foreignObject>",
        ...
        contextMenu: function(b, a, e, c, f, g, h) {
            ...
            if (!i) d[k] = i = j("div", {
                ...
                m(a, function(a) {
                    if (a) {
                        var b = a.separator ? j("hr", null, null, w) : j("div", {
            ...
            c + g + d.exportMenuHeight > o && h.alignOptions.verticalAlign !== "top" ? a.bottom = o - c - u + "px" : a.top = c + g - u + "px";
            v(i, a);
            d.openMenu = !0
        },
